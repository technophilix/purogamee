...
<html>
    <head>
        <meta charset="UTF-8">
        <link rel="icon" type="image/png" href="<?php echo getLogo() ?>">
        <title><?php echo $this->Site->getSitedata()->name . " | 404" ?></title>
    </head>
	...
	<div class="left-section">
		<div class="inner-content">
			<h1 class="heading">404</h1>
                        <p class="subheading">Looks like the page you were looking for is no longer here. Go to <a href="<?php echo base_url() ?>" style="text-decoration: none; color:wheat">Home page</a>.</p>
